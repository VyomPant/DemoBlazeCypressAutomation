...
import {buy} from '../pageObjects/samecart-addition.page.js';
import {cart} from '../pageObjects/samecart-addition.page.js';



describe('Select  Laptop and add it to cart', function(){
    let credentials;
    let paying;
...
describe('Checkout Three Laptops ', function(){
    let paying;
    let credentials;
    before ('Go to the main page', function () {
        // load credentials
