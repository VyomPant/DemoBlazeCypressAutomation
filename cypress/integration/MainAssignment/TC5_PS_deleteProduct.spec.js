...
import {buy} from '../pageObjects/cart-addition.page.js';
import {cart} from '../pageObjects/cart-addition.page.js';


describe('Select Mobile and add it to cart', function(){
    let credentials;
    let paying;
...
describe('Checkout products after deleting one product in cart', function(){
    let paying;
    let credentials;
    before ('Go to the main page', function () {
        // load credentials
    ...
    it ('Should display three products in the cart', function(){
