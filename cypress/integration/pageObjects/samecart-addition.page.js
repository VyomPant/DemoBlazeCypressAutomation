...
const product = {
    thirdProduct: () => cy.get('.card-block a').eq(7),
...
export const cart = {
 ...
 // firstProduct: () => cy.get('.card-block a').eq(7),// monitor and phone
    // // secondProduct: () => cy.get('.card-block a').eq(4), //monitor 2
    // // thirdProduct: () => cy.get('.card-block a').eq(7), //laptop 1
    // // fourthProduct: () => cy.get('.card-block a').eq(8), //laptop 2